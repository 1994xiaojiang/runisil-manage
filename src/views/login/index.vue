    ...
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" auto-complete="on" label-position="left">
      ...
      <el-form-item>
        <div class="identifybox">
          <img :src="verifyCodeUrl" style="width: 110px;height: 47px;cursor: pointer;" alt="验证码" @click="refreshCode" />
  ...
  data() {
    ...
    const validateVerifyCode = (rule, value, callback) => {
      if (value.length !== 4) {
        ...
        const value = { 'verifycode': this.loginForm.verifycode }
        judgeCode(value).then(response => {
